...
>
> **Pre-Market Research: [Sunday Apr 12](knowledge/premarket-research/20260412.md) — Hormuz blockade, futures crash, Asia outlook
...
See **[LEADERBOARD.md](LEADERBOARD.md)** for all 204 strategies with full rankings and formula details.
...
2. System matches against 173 backtested204 strategies by universe overlap
...
7. **Re-roll:** GUI shows 204 strategies in a carousel with shuffle
...
agents-assemble/
  agents_assemble/              # Python package (pip install -e .)
   ...
   204 strategies/                 # All strategy implementations (13 modules)
  ...
  LEADERBOARD.md                # Definitive strategy rankings (204 strategies)
...
- **Always backtest** — 72 of 204 strategies lost money despite sounding good
