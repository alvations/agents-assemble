...
Trading agents and algorithms for publicly tradable instruments. **227 strategies**, 720+ tickers, ranked by Composite Score across 28 rolling windows (2015-2025).
...
See **[LEADERBOARD.md](LEADERBOARD.md)** for all 227 strategies with full rankings and formula details.
...
2. System matches against 227 backtested strategies by universe overlap
...
7. **Re-roll:** GUI shows 227 strategies in a carousel with shuffle
...
agents-assemble/
  agents_assemble/              # Python package (pip install -e .)
    ...
    strategies/                    # All strategy implementations (13 modules, 227 strategies)
  ...
  LEADERBOARD.md                # Definitive strategy rankings (227 strategies)
...
- **Always backtest** — 72+ of 227 strategies lost money despite sounding good
