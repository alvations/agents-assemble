...
| Category | Count | File |
|----------|-------|------|
| Unconventional | 52 | unconventional_strategies.py |
| Themes | 51 | theme_strategies.py |
| Famous Investors | 20 | famous_investors.py |
| Portfolio | 26 | portfolio_strategies.py |
| Research | 16 | research_strategies.py |
...
| Hedge Fund | 8 | hedge_fund_strategies.py |
