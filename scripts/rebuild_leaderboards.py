...
def build_leaderboard(mw, strat_files, result_jsons, strat_jsons):
    ...
    lines.append("")
    lines.append("By using this information, you acknowledge that you understand and accept these risks and that AI-generated content requires independent verification.")
