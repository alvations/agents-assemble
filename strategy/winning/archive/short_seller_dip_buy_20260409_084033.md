...
>
> **Hypothesis:** Short Seller Dip Buy — consistency: 100% across 6 windows

**Generated:** 2026-04-09T08:40:33.232808
...
|--------|--------|-----|-------|-----------|-------------|------|------------|
| **META** | BUY | 36% | Market order (volatile) | 20.8% below entry | 15.7% above entry | 8.1% of portfolio | [Chart](https://www.tradingview.com/chart/?symbol=META) / [Yahoo](https://finance.yahoo.com/quote/META/) |
...
- **Stop loss:** NO price-based stop loss. This strategy recovered from -28% drawdown to return 174% over the long term. Stopping out would have locked in losses.
