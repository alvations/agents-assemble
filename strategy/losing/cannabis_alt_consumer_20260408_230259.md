# LOSING Strategy: cannabis_alt_consumer

> **What it does:** Contrarian cannabis: pre-legalization value, binary regulatory catalyst
>
> **Hypothesis:** Cannabis & Alt Consumer 4Y (2022-2025)

**Generated:** 2026-04-08T23:02:59.533730
...
|--------|--------|-----|-------|-----------|-------------|------|------------|
| **GTBIF** | BUY | 81% | Market order (volatile) | 40.0% below entry | 15.0% above entry | 0.0% of portfolio | [Chart](https://www.tradingview.com/chart/?symbol=GTBIF) / [Yahoo](https://finance.yahoo.com/quote/GTBIF/) |
...
- Max drawdown: -62.80% (target > -20%)
- Alpha: -21.69% (target > 0%)
