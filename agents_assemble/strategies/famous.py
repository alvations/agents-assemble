...
class PeterLynch(BasePersona):
    ...
    def generate_signals(self, date, prices, portfolio, data):
        ...
        for sym in self.config.universe:
            ...
            ret = self._get_indicator(data, sym, "daily_return", date)
...
class HowardMarks(BasePersona):
    ...
    def generate_signals(self, date, prices, portfolio, data):
        ...
        spy_vol = self._get_indicator(data, "AAPL", "vol_20", date)  # Use AAPL as proxy
        ...
        for sym in self.config.universe:
            ...
            # Risk control: exit if thesis breaking
